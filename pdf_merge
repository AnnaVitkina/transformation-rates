...
input_drive_folder = '/content/drive/MyDrive/RMT test/Archive'

# Define the base output folder in Google Drive
output_base_folder = '/content/drive/MyDrive/RMT/processing'
...
output_filename = input("Enter output file name (e.g., 'my_merged_doc.pdf', press Enter for 'merged_output.pdf'): ").strip()
...
merge_pdfs_from_folder(input_drive_folder, output_drive_file)
